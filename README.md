...
* **Comparison with algebraic geometry.** The canonical morphism of locally ringed spaces from
  ...
  injective and landing in the closed points (`Oka/Analytification/AffineSpace.lean`). This is
  the base case of analytification; the induced map on stalks, and its flatness, are not yet
  proved.
