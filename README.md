...
**Since 2026-09-15 it also reads the `…`-elided citations**, which are this repository's house
...
component rather than a namespace and reading 207 of them as citations would report 29 on a tree
with no such defect.
