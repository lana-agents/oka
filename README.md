...
* **Analytification as a functor.** Presentations form a category, the analytification is a
  ...
  the statement. The comparison morphism `X^an ⟶ X` is **not yet natural in the presentation**,
  so this is a functor to analytic spaces and not yet one over affine `ℂ`-schemes.
