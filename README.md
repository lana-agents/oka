...
* **Comparison with algebraic geometry.** The canonical morphism of locally ringed spaces from
  ...
  localisation-to-germs map (`Oka/Analytification/AffineSpace.lean`). This is the base case of
  analytification; **flatness** of that stalk map, the analytic input to GAGA, is not yet
  proved.
