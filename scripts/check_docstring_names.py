...
until 2026-09-15 this check could not see one — and by the enumeration this file opens with,
...
def self_test() -> int:
    ...
    **The test that matters is the positive one.**  "Two identical trees diff to empty" is what
    ...
    able to see that none is missing.  **It was eighteen and eight until 2026-09-15**, when the
    ...
    **The last ten are the elided citations and arrived with taxis #2056.**  They are the only
    ...
    with tempfile.TemporaryDirectory(prefix="oka-docstring-names-selftest-") as tmp:
        ...
        # Until 2026-09-15 a citation beginning `…` was not a candidate at all — `is_name_shaped`
