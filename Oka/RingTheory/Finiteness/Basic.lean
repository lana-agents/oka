...
the two scalar rings are isomorphic and **the carrier does not change**: one abelian group `N`
...
theorem of_ringEquiv {A B N : Type*} [CommRing A] [CommRing B] [AddCommGroup N]
